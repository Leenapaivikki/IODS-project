...
Next we will fit a random intercept and slope model that allows for a treatment × week interaction to BPRS Data. We conduct an ANOVA to compare this with the above models.
